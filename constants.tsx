...
export const SYLHET_RESTAURANTS: Restaurant[] = [
  { id: 1, name: "Panshi Restaurant", cuisine: "Traditional Bengali", rating: 4.8, time: "15m", distance: "4.5 km", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&q=80&w=800", tag: "🥘 Must Visit", description: "The most famous restaurant in Sylhet. Try their duck curry and 30+ types of Bhorta.", phone: "+8801711223344", isRecommended: true },
  { id: 2, name: "Pach Bhai Restaurant", cuisine: "Bengali", rating: 4.7, time: "18m", distance: "4.6 km", image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&q=80&w=800", tag: "🍛 Authentic", description: "Rival to Panshi, famous for variety and authentic Sylheti fish dishes.", phone: "+8801711223355", isRecommended: true },
  { id: 3, name: "Woondaal King Kebab", cuisine: "Mughlai", rating: 4.6, time: "20m", distance: "4.8 km", image: "https://images.unsplash.com/photo-1561758033-d89a9ad46330?auto=format&fit=crop&q=80&w=800", tag: "🍢 Fine Dining", description: "Best kebabs and Biryani in a royal environment at Zindabazar.", phone: "+8801711223366", isRecommended: true },
  { id: 4, name: "Eatopia", cuisine: "Multi-Cuisine", rating: 4.5, time: "22m", distance: "5.0 km", image: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?auto=format&fit=crop&q=80&w=800", tag: "🍕 Global", description: "Modern multicuisine restaurant perfect for families and large groups.", phone: "+8801711223377" },
  { id: 5, name: "Handi Restaurant", cuisine: "North Indian", rating: 4.7, time: "25m", distance: "5.2 km", image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&q=80&w=800", tag: "🥘 Spicy", description: "Authentic Indian Handi cuisine and butter chicken in the heart of Zindabazar.", phone: "+8801711223388" },
  ...
  { id: 7, name: "Chicken Hut", cuisine: "Fast Food", rating: 4.2, time: "12m", distance: "3.5 km", image: "https://images.unsplash.com/photo-1562967914-608f82629710?auto=format&fit=crop&q=80&w=800", tag: "🍗 Fried", description: "Reliable local favorite for fried chicken and snacks in Ambarkhana.", phone: "+8801711223300" },
...
export const SYLHET_ATTRACTIONS: Attraction[] = [
  { id: 1, name: "Keane Bridge", subtitle: "Historic Landmark", distance: "0.8 km", description: "The 'Gateway to Sylhet'. An iconic 1936 steel structure offering panoramic river views.", image: "https://images.unsplash.com/photo-1589302168068-964664d93dc0?auto=format&fit=crop&q=80&w=800", mapUrl: "https://www.google.com/maps/search/?api=1&query=Keane+Bridge+Sylhet", isRecommended: true },
  { id: 2, name: "Shah Jalal Dargah", subtitle: "Spiritual Center", distance: "1.5 km", description: "The most sacred spiritual site in the region, housing the tomb of the famous saint.", image: "https://images.unsplash.com/photo-1561758033-d89a9ad46330?auto=format&fit=crop&q=80&w=800", mapUrl: "https://www.google.com/maps/search/?api=1&query=Shah+Jalal+Dargah+Sylhet", isRecommended: true },
