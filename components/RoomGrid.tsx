...
const RoomGrid: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto pt-24 pb-20 px-6 bg-white">
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
        <div className="max-w-2xl">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-hotel-primary mb-4 leading-tight font-black">Curated Sanctuary</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {ROOMS_DATA.map((room) => (
          <div key={room.id} className="bg-white rounded-[2.5rem] overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.02)] border border-hotel-muted group hover:shadow-[0_40px_80px_rgba(229,57,53,0.12)] transition-all duration-700 flex flex-col h-full">
            <div className="h-64 relative overflow-hidden">
              ...
              <div className="absolute top-5 right-5 bg-hotel-primary text-white w-12 h-12 rounded-full shadow-2xl flex flex-col items-center justify-center ring-4 ring-white/30">
                <span className="text-[11px] font-black leading-none">25%</span>
            ...
            <div className="p-7 flex flex-col flex-1">
              <div className="flex justify-between items-start mb-4">
                <div className="flex-1">
                  <h3 className="text-xl font-serif text-hotel-text font-black leading-tight group-hover:text-hotel-primary transition-colors">{room.title}</h3>
                ...
                <div className="text-right">
                   <p className="text-[10px] text-gray-300 font-bold line-through">৳{(parseInt(room.price.replace(/,/g, '')) * 1.33).toLocaleString()}</p>
                   <p className="text-2xl font-black text-hotel-primary leading-none">৳{room.price}</p>
                </div>
              </div>
              ...
              <div className="mt-auto">
                <button className="w-full bg-hotel-primary text-white py-5 rounded-[1.5rem] font-black text-[11px] uppercase tracking-[0.2em] shadow-xl shadow-red-50 group-hover:bg-hotel-secondary transition-all active:scale-[0.97] flex items-center justify-center gap-3">
